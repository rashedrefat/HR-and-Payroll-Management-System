  ...
  const settingsCategories = [
    {
      ...
      description: "Configure shift schedules and working hours",
      icon: (
        <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      ),
      link: "/settings/shift-settings",
      color: "bg-blue-50 border-blue-200 hover:bg-blue-100",
      iconBg: "bg-blue-100",
      features: ["Shift Management", "Working Days", "Grace Periods", "Time Zones"]
    },
    {
      ...
      iconBg: "bg-green-100",
      features: ["Leave Types", "Leave Days", "Leave Policies", "Type Management"]
    },
    {
