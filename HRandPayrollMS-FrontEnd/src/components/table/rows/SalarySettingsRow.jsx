...
export default function SalarySettingsRow({ data, onEdit, onDelete }) {
          ...
          <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4 shadow-xl border border-gray-200">
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">Delete Salary Component</h3>
                </div>
              </div>
              <div className="mb-6">
                <p className="text-sm text-gray-600">
                  Are you sure you want to delete the salary component "{data?.name}"? This action cannot be undone and will permanently remove this component from all salary calculations.
                </p>
              </div>
