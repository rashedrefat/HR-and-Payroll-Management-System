...
function Table({
  ...
  const childrenForCurrentPage = React.Children.toArray(children).slice(
    startIndex,
    endIndex
  );
  ...
  return (
    <div className={`rounded-lg border border-red-50 overflow-x-auto`}>
              ...
              (page) => (
                <button
                  ...
                  className={`px-3.5 py-1 rounded ${
                    currentPage === page
                      ? "bg-default-theme text-gray-800 text-sm font-semibold"
