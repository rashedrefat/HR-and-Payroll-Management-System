    ...
    <section className="px-6 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:from-green-600 hover:to-green-700 cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold mt-2">{stats.averageAttendance}%</p>
            </div>
            <div className="bg-green-800 bg-opacity-80 rounded-full p-4 transition-all duration-300 hover:bg-opacity-100 hover:scale-110 flex items-center justify-center">
              <img src="/icons/attendance.svg" alt="Average Attendance" className="w-8 h-8 filter brightness-0 invert" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-6 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:from-orange-600 hover:to-orange-700 cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-orange-100 text-sm font-medium">Perfect Attendance</p>
              <p className="text-3xl font-bold mt-2">{stats.onTimeEmployees}</p>
            </div>
            <div className="bg-orange-800 bg-opacity-80 rounded-full p-4 transition-all duration-300 hover:bg-opacity-100 hover:scale-110 flex items-center justify-center">
              <img src="/icons/present.svg" alt="Perfect Attendance" className="w-8 h-8 filter brightness-0 invert" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-xl p-6 text-white transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:from-red-600 hover:to-red-700 cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-red-100 text-sm font-medium">Total Late Entries</p>
              <p className="text-3xl font-bold mt-2">{stats.lateComers}</p>
            </div>
            <div className="bg-red-800 bg-opacity-80 rounded-full p-4 transition-all duration-300 hover:bg-opacity-100 hover:scale-110 flex items-center justify-center">
              <img src="/icons/timeline.svg" alt="Late Entries" className="w-8 h-8 filter brightness-0 invert" />
            </div>
          </div>
        </div>
      </div>
